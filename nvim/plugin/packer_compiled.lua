...
_G.packer_plugins = {
  ...
  ["everforest-nvim"] = {
    ...
    loaded = true,
    path = "/home/felix/.local/share/nvim/site/pack/packer/start/everforest-nvim",
  ...
  ["rainbow-delimiters.nvim"] = {
    loaded = true,
    path = "/home/felix/.local/share/nvim/site/pack/packer/start/rainbow-delimiters.nvim",
